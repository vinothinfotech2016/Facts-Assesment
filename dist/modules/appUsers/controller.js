...
exports.updateUser = exports.userLogin = exports.getAppUsers = exports.createAppUser = void 0;
 ...
 *
 */
const createAppUser = (handler) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield handler.getBody();
        const res = yield service_1.default.createAppUser(data);
...
const getAppUsers = (handler) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const res = yield service_1.default.getAppUsers();
        return handler.handleCreatedResponse(res);
    }
    catch (err) {
        return handler.sendServerError(err);
 ...
 */
const userLogin = (handler) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield handler.getBody();
        const res = yield service_1.default.userLogin(data);
        return handler.handleCreatedResponse(res);
    }
    catch (err) {
        return handler.sendServerError(err);
...
const updateUser = (handler) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield handler.getBody();
        const userId = yield handler.getRequestParameterAsString("userId");
        const res = yield service_1.default.updateUser(data, userId);
        return handler.handleCreatedResponse(res);
    }
    catch (err) {
        return handler.sendServerError(err);
