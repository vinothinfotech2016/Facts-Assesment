...
function default_1(app) {
    app.post("/createCustomer", (0, request_handler_1.handle)(controller.createCustomer));
    app.put("/updateCustomer/:customerId", (0, request_handler_1.handle)(controller.updateCustomer));
    app.post("/customerLogin", (0, request_handler_1.handle)(controller.customerLogin));
    app.get("/getCustomers", (0, request_handler_1.handle)(controller.getCustomers));
